...
public class IndividualLessonsScheduleRequestStub {
    ...
    public static IndividualLessonsScheduleRequest createWithScheduleTypeFixedDurationLessons(Long allLessonsDurationInMinutes) {
        ...
        return new IndividualLessonsScheduleRequest(LocalDate.now(), null, ScheduleType.FIXED_DURATION_LESSONS, allLessonsDurationInMinutes, lessonsDaysOfWeekWithTimes, null, ORGANIZATION_EMAIL_ADDRESS_STUB, STUDENT_EMAIL_ADDRESS_STUB);
    }
